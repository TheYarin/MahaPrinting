...
import MaterialTable, { Icons, MTableToolbar, MaterialTableProps } from "material-table";
...
@observer
class StyledMaterialTable extends Component<WithStyles<typeof styles>, MaterialTableProps<any>> {
    render() {
        ...
        const finalColumns = [
            ...
            ...columns.filter(c => !(["id", "name"].includes(c.field)))
        ]
